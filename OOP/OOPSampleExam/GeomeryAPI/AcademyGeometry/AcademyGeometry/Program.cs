...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            ...
            double sideArea = 2 * Math.PI * this.Radius * (this.Top - this.Bottom).Magnitude;
    ...
    public class AdvancedFigureController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        IAreaMeasurable figure = currentFigure as IAreaMeasurable;
                        if (figure != null)
                        {
                            Console.WriteLine("{0:f2}", figure.GetArea());
                        }
                        else
                        {
                ...
                case "volume":
                    {
                        IVolumeMeasurable figure = currentFigure as IVolumeMeasurable;
                        if (figure != null)
                        {
                            Console.WriteLine("{0:f2}", figure.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        IFlat figure = currentFigure as IFlat;
                        if (figure != null)
                        {
                            Console.WriteLine("{0:f2}", figure.GetNormal());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
